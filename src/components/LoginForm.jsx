  ...
  return (
    <div className="flex flex-col justify-center items-center w-full md:w-1/2 min-h-screen px-10 bg-white">
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">
        Log to Your Profile <span className="text-blue-600 font-bold">Now!</span>
      </h2>
      <p className="text-sm text-gray-500 mb-6 text-center">
        Log to a profile to save your learning progress and keep learning for free!
      </p>

      <form onSubmit={handleLogin} className="w-full max-w-sm space-y-4">
        <div>
          <label className="text-sm font-semibold text-blue-700">Input Your Email</label>
          <input
            type="email"
            placeholder="Email"
            value={email}
        ...
        <div>
          <label className="text-sm font-semibold text-blue-700">Input Your Password</label>
          <input
            type="password"
